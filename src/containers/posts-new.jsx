        ...
        return (
            <div className="posts-new container">
                <form onSubmit={ handleSubmit(this.onSubmit.bind(this)) } className="post-new-form">
                    <Field name="firstName" label="First Name" type="text" component={this.renderInputField}/>
                    <Field name="lastName" label="Last Name" type="text" component={this.renderInputField}/>
                    <Field name="age" label="Age" type="text" component={this.renderInputField}/>
                    <Field name="status" label="Status" type="text" component={this.renderInputField}/>
                    <Field name="gender" label="Gender" type="text" component={this.renderInputField}/>
                    <Field name="image" label="image" type="text" component={this.renderInputField}/>
